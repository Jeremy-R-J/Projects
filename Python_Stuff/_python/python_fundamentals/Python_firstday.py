...
#   2.) Immutability  strings cannot be changed
#   3.) while loops
...
# first_name = "jeremy"
# last_name = "johns"
# print(greeting + "My name is" + first_name + last_name + "I am" + str(age))

# # print(greeting,"my name is", first_name, last_name)
# # full_greeting = f" {greeting} My name is {first_name}, {last_name}"
# # print (full_greeting)

# # left side-> address in memory
# # right side is always the value
